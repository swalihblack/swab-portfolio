...
export const fallbackBlogPosts: BlogPost[] = [
  {
    ...
    date: '2026-03-26',
    excerpt:
      'Mastering design means knowing the rules—and knowing exactly when to break them for maximum impact. Discover how strategic deviation creates memorable visual identities.',
    tags: ['Design Theory', 'Layout', 'Branding', 'Visual Identity', 'UI/UX'],
    coverUrl: `${GITHUB_RAW}/blogs/001-Grids/cover.webp`,
    content: `Design is often misunderstood as pure, unbridled creativity. In reality, the most compelling work is rooted in structure. Before a single pixel is placed, there is an underlying framework—a grid—that ensures consistency, readability, and balance. But there comes a point in every designer's journey where following the rules becomes too safe. 
...
![A clean, minimalist Swiss Style layout showing strict column alignment and structured typography](${GITHUB_RAW}/blogs/001-Grids/photo1.webp)
...
![A wireframe layout where specific elements begin to overflow their designated containers slightly](${GITHUB_RAW}/blogs/001-Grids/photo2.webp)
...
![Bold typography breaking alignment lines, creating a sense of motion and urgency](${GITHUB_RAW}/blogs/001-Grids/photo3.webp)
...
![An asymmetric layout example showing uneven margins used to draw focus to a central image](${GITHUB_RAW}/blogs/001-Grids/photo4.webp)
...
![Layered design elements overlapping each other, defying traditional grid boundaries](${GITHUB_RAW}/blogs/001-Grids/photo5.webp)
...
![A final polished branding mockup that successfully uses broken grid techniques for high impact](${GITHUB_RAW}/blogs/001-Grids/photo6.webp)
...
If you're looking for a design partner who knows when to follow the rules and when to rewrite them, let's collaborate.`,
    images: [
      `${GITHUB_RAW}/blogs/001-Grids/photo1.webp`,
      `${GITHUB_RAW}/blogs/001-Grids/photo2.webp`,
      `${GITHUB_RAW}/blogs/001-Grids/photo3.webp`,
      `${GITHUB_RAW}/blogs/001-Grids/photo4.webp`,
      `${GITHUB_RAW}/blogs/001-Grids/photo5.webp`,
      `${GITHUB_RAW}/blogs/001-Grids/photo6.webp`,
    ],
    folderUrl: 'https://github.com/swalihblack/swab-portfolio/tree/main/blogs/001-Grids',
  },
];
